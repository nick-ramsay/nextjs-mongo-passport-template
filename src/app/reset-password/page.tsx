...
export default function ResetPassword() {
  ...
  const submitRequest = (resetCode: string, newPassword: string, confirmNewPassword: string, event: React.FormEvent<HTMLFormElement>) => {
  ...
  return (
    <div className="grid items-center justify-center h-screen w-screen">
      <div className="form-card xs-sm:w-96 x-sm:w-96 sm:w-96 md:w-full lg:w-full xl:w-full">
        ...
        <form onSubmit={(event) => submitRequest(resetCode, newPassword, confirmNewPassword, event)}>
